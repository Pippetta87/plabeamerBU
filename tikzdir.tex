...
\draw[->] (2.5,2.5,0)node[draw,circle,inner sep=0] (o) {} -- (2.5,2.5,3)node[below] {$\vec{J}$};
...
\begin{filecontents}{reducedproblem.tex}%reduced problem
...
\begin{filecontents}{ellipse.tex} % ellisse
