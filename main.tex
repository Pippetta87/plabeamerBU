...
\begin{frame}[allowframebreaks]{Sistemi planetari: argomenti del corso}\linkdest{intro}\phantomsection
...
\part{Moto 2 corpi in potenziale newtoniano}\linkdest{part:kepler}
...
\section{Determinazione orbita da 3 osservabili (Solar system)}\linkdest{sec:orbitobs}
\input{obs2orb}

\part{Problema Newtoniano: meccanica analitica.}\linkdest{part:analytics}
\begin{frame}{this part toc}
\begin{itemize}
...
\part{Attrazione non Newtoniana, orbite non Kepleriane: perturbazioni.}\linkdest{part:perturbation}
\begin{frame}{this part toc}
\begin{itemize}
...
\part{Orbite non Kepleriane: problema dei 3 corpi.}\linkdest{part:threebody}
\begin{frame}{this part toc}
\begin{itemize}
