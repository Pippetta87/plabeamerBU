...
\usepackage{tikzdir}%%contain tikz files as filecontents
\usepackage{sources}
...
\def\status{scillaing}
\def\keeptrying{keeptrying}
\usepackage{LocalF}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\title{Sistemi Planetari (Beamer)}

% A subtitle is optional and this may be deleted
\subtitle{Orbite, fenomenologia, formazione.}
...
\subject{Orbite osservazione formazione sistemi planetari}
...
\part{Meccanica celeste}\label{celestial}
\frame{\partpage}

\input{twobody}

\part{Attrazione non Newtoniana: orbite non Kepleriane.}
