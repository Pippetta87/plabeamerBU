\section{Primario non sferico}\linkdest{asph}
...
\section{Metodo di Newton}\linkdest{Nmethod}
\begin{equation*}
...
\section{Precessione luni-solare}\linkdest{MSprec}
...
\section{Perturbazioni}\linkdest{sec:pert}
