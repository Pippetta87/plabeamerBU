...
\begin{wordonframe}{Termine perturbativo in funzione delle variabili canoniche}
...
\begin{align*}
&\dot{\phi}=\PDy{J_{\phi}}{H_0}+\PDy{J_{\phi}}{H_1}\approx n(1+\frac{3R^2}{4a^2}J_2\frac{2-3\sin^2{i}}{()\expy{\frac{3}{2}}})\\
...
\begin{figure}[!ht]\includegraphics[width=\textwidth]{peripert}\end{figure}

\begin{figure}[!ht]\includegraphics[width=\textwidth]{nodepert}\end{figure}
